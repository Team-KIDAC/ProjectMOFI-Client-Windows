            ...
            <View style={styles.style3}>
                ...
                <View style={styles.style16}>
                    <View style={styles.style8}>
                        ...
                        <View style={styles.style7}>
                            <TouchableOpacity style={styles.style18}>
                            <Text style={styles.style14} >Compare With Database</Text>
                            <Image source={require('../assets/icons/sync_white_24dp.svg')} style={styles.style19} />
                            </TouchableOpacity>
                        </View>
                    </View>
                    <View style={styles.style8}>
                    ...
                    <View style={styles.style7}>
                        <Text style={styles.style20} >Access Denied</Text>
                            <Image source={require('../assets/icons/times-circle-solid.svg')} style={styles.style21} />
